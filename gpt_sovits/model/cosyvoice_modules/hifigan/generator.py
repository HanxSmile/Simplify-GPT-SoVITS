...
@registry.register_model("hift_generator")
class HiFTGenerator(nn.Module):
    ...
    def build_from_cfg(cls, cfg):
        f0_predictor_cfg = cfg.f0_predictor

        f0_predictor = ConvRNNF0Predictor(
            num_class=f0_predictor_cfg.num_class,
            in_channels=f0_predictor_cfg.in_channels,
            cond_channels=f0_predictor_cfg.cond_channels,
        )
        return cls(
            ...
            source_resblock_dilation_sizes=cfg.source_resblock_dilation_sizes,
