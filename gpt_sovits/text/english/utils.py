...
CMU_DICT_PATH = os.path.join(current_file_path, "assets", "cmudict.rep")
CMU_DICT_FAST_PATH = os.path.join(current_file_path, "assets", "cmudict-fast.rep")
CMU_DICT_HOT_PATH = os.path.join(current_file_path, "assets", "engdict-hot.rep")
CACHE_PATH = os.path.join(current_file_path, "assets", "engdict_cache.pickle")
NAMECACHE_PATH = os.path.join(current_file_path, "assets", "namedict_cache.pickle")
