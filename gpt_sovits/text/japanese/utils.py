...
USERDIC_CSV_PATH = os.path.join(current_file_path, "assets", "userdict.csv")
USERDIC_BIN_PATH = os.path.join(current_file_path, "assets", "user.dict")
USERDIC_HASH_PATH = os.path.join(current_file_path, "assets", "userdict.md5")
